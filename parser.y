...
params : expressao               {$$ = $1;}
       | expressao COMMA params  {char * s = cat($1->code, ",", $3->code, "", "");
                                    freeRecord($1);
                                    freeRecord($3);
                                    $$ = createRecord(s, "");
                                    free(s);
...
term_sec : term_prim sec_ops term_sec {char * s = cat($1->code, $2->code, $3->code, "", "");
                                          freeRecord($1);
                                          freeRecord($2);
                                          freeRecord($3);
                                          $$ = createRecord(s, "");
...
term_prim: factor prim_ops term_prim {char * s = cat($1->code, $2->code, $3->code, "", "");
                                          freeRecord($1);
                                          freeRecord($2);
                                          freeRecord($3);
                                          $$ = createRecord(s, "");
